...
📊 Average Streak: 3.8 days
🔥 Total Streaks: 21
📅 First Run: 2025-03-03
⏱️  Days Active: 109 days
💯 Consistency: 28.2% (109/387 days)
```
...
```
Week 2/24-3/2     ▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓     6 runs
Week 3/3-3/9      ▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓              4 runs
Week 3/10-3/16    ▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓ 7 runs
Week 3/17-3/23    ▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓     6 runs
```
