...
📊 Average Streak: 3.5 days
🔥 Total Streaks: 20
📅 First Run: 2025-03-03
⏱️  Days Active: 100 days
💯 Consistency: 26.5% (100/377 days)
```
...
```
Week 2/14-2/20    ▓▓▓▓▓▓▓▓▓▓▓▓▓                  3 runs
Week 2/21-2/27    ▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓     6 runs
Week 2/28-3/6     ▓▓▓▓▓▓▓▓▓▓▓▓▓                  3 runs
Week 3/7-3/13     ▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓ 7 runs
```
